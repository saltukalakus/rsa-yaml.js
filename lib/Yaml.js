...
Yaml = (function() {
  ...
  Yaml.dump = function(input, inline, indent, exceptionOnInvalidType, objectEncoder, metaDataConf) {
    var yaml;
    if (inline == null) {
      inline = 2;
    }
    ...
    return yaml.dump(input, inline, 0, exceptionOnInvalidType, objectEncoder, false, metaDataConf);
  };
