...
Inline = (function() {
  ...
  Inline.dump = function(value, exceptionOnInvalidType, objectEncoder, myValue, doubleQuotesFound, metaDataConf) {
    ...
    if (type === 'object') {
      ...
      return this.dumpObject(value,  exceptionOnInvalidType, null, metaDataConf);
    }
    if (type === 'boolean') {
    ...
    if ((_ref = value.toLowerCase()) === 'null' || _ref === '~') {
      return "'" + value + "'";
    }
    // Hack!
    if ( myValue == true) {
      if (doubleQuotesFound == true) {
  ...
  Inline.dumpObject = function(value, exceptionOnInvalidType, objectSupport, metaDataConf) {
    ...
    if (value instanceof Array) {
      ...
      for (_i = 0, _len = value.length; _i < _len; _i++) {
        ...
        type = typeof val;
        if (type === 'object')
            output.push(this.dump(val,exceptionOnInvalidType,objectSupport,false, false, metaDataConf));
        else
            output.push(this.dump(val,exceptionOnInvalidType,objectSupport,true, false, metaDataConf));
      }
      return '[' + output.join(', ') + ']';
    } else {
      output = [];
      for (key in value) {
        ...
        output.push(this.dump(key,exceptionOnInvalidType,objectSupport,false, false, metaDataConf) + ': ' + this.dump(val,exceptionOnInvalidType,objectSupport,true, doubleQuotesFound, metaDataConf));
      }
      return '{' + output.join(', ') + '}';
    }
  };
