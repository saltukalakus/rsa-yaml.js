...
Inline = (function() {
  ...
  Inline.dump = function(value, exceptionOnInvalidType, objectEncoder, myValue) {
  ...
  Inline.dumpObject = function(value, exceptionOnInvalidType, objectSupport) {
    ...
    if (value instanceof Array) {
      ...
      for (_i = 0, _len = value.length; _i < _len; _i++) {
        ...
        type = typeof val;
        if (type === 'object')
            output.push(this.dump(val,exceptionOnInvalidType,objectSupport,false));
        else
            output.push(this.dump(val,exceptionOnInvalidType,objectSupport,true));
      }
      return '[' + output.join(', ') + ']';
    } else {
      output = [];
      for (key in value) {
        val = value[key];
        output.push(this.dump(key,exceptionOnInvalidType,objectSupport,false) + ': ' + this.dump(val,exceptionOnInvalidType,objectSupport,true));
      }
      return '{' + output.join(', ') + '}';
    }
  };
